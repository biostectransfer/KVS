...
<asp:Panel runat="server" ID="Panel5">
    ...
    <telerik:RadTextBox runat="server" Enabled="false" Visible="True" DisabledStyle-ForeColor="Black"
        BorderColor="Transparent" DisabledStyle-BackColor="Transparent" Text="Bitte wählen Sie einen Kunden aus: " ID="RadTextBox1" Width="240px">
    </telerik:RadTextBox>
    ...
    <br />
    <telerik:RadTextBox runat="server" Enabled="false" Visible="True" DisabledStyle-ForeColor="Black"
        BorderColor="Transparent" DisabledStyle-BackColor="Transparent" Text="Zulassungsdatum: " ID="RadTextBox4" Width="240px">
    </telerik:RadTextBox>
            ...
            <EditFormSettings InsertCaption="Auftrag abmelden" EditColumn-HeaderText="Dieses Auftrag abmelden?" EditFormType="Template" PopUpSettings-Modal="true">
                <FormTemplate>
                    ...
                    <table id="Table1" cellspacing="1" cellpadding="1" width="250" border="0">
                        ...
                        <asp:TextBox ID="orderIdBox" Visible="false" Text='<%# Bind( "OrderNumber") %>' runat="server"> </asp:TextBox>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox runat="server" ID="ErrorCheckBox" AutoPostBack="false" />
                                <%--OnCheckedChanged = "ErrorCheckBox_Clicked"--%>
                            </td>
                            <td>Ursache
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td align="right" colspan="2">
                                <p>
                                    <asp:Button ID="ZulassenButton" Text="Änderung speichern" runat="server" OnClick="ZulassungZulassen_Command"></asp:Button>&nbsp;
                                <asp:Button ID="Button12" Text="Schließen" runat="server" CausesValidation="False" CommandName="Cancel"></asp:Button>
                                </p>
                            </td>
                        </tr>
                    </table>
