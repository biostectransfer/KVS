                ...
                <table id="Table1" cellspacing="1" cellpadding="1" border="0">
                    <tr>
                        ...
                        <td>
                            ...
                            <%--OnTextChanged = "DispatchOrderNumberBoxText_Changed"  --%>  
                        </td>
                        <td>&nbsp;
                        ...
                        <td>
                            <asp:Button Text="Lieferscheine erstellen" runat="server" ID="LieferscheinDruckenButton" OnClick="DrueckenButton_Clicked"></asp:Button>
                        </td>
                        <td></td>
                    </tr>
                </table>
