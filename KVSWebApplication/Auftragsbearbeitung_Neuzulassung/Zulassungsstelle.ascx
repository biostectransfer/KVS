...
<asp:LinqDataSource TableName="Customer" ID="LinqDataSourceZulassung" runat="server" OnSelecting="OrderLinq_Selected" ContextTypeName="KVSCommon.Database.DataClasses1DataContext">
</asp:LinqDataSource>
