<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AbmeldungGrosskundeControl.ascx.cs" Inherits="KVSWebApplication.Auftragseingang.AbmeldungGrosskundeControl" %>
            ...
            <td>
                <div style="float: right; z-index: 100; position: absolute; border: 1px solid;">
                    ...
                    &nbsp;&nbsp;&nbsp;<telerik:RadTreeView Skin="Office2010Blue" CollapseAnimation-Type="InOutCubic" ID="DienstleistungTreeView"
                        runat="server" Height="110px" Width="300px">
                    </telerik:RadTreeView>
                </div>
            </td>
        </tr>
    ...
    <asp:Panel runat="server" ID="Halter">
        ...
        <asp:Panel runat="server" Visible="false" ID="CarOwner_Name">
            <telerik:RadTextBox runat="server" Enabled="false" Visible="true" DisabledStyle-ForeColor="Black"
                BorderColor="Transparent" DisabledStyle-BackColor="Transparent" Text="Firma: " ID="OwnerNameLabel" Width="240px">
            </telerik:RadTextBox>
        ...
        <asp:Panel runat="server" Visible="false" ID="CarOwner_Firstname">
            <telerik:RadTextBox runat="server" Enabled="false" Visible="True" DisabledStyle-ForeColor="Black"
                BorderColor="Transparent" DisabledStyle-BackColor="Transparent" Text="Ansprechpartner (Vorname/Nachname): " ID="OwnerFirstNameLabel" Width="240px">
            </telerik:RadTextBox>
