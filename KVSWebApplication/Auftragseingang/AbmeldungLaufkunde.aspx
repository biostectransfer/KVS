<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AbmeldungLaufkunde.aspx.cs" Inherits="KVSWebApplication.Auftragseingang.AbmeldungLaufkunde" %>

<%@ Register TagPrefix="smc" TagName="SmallCustomer" Src="AbmeldungLaufkundeControl.ascx" %>
                    ...
                    <div class="exampleWrapper">
                        ...
                        <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1" LoadingPanelID="LoadingPanelAuftragseingang" Height="100%" Width="1400px">
                            <div style="float: left;">
                                <smc:SmallCustomer ID="SmallCustomer" runat="server" />
                            </div>
