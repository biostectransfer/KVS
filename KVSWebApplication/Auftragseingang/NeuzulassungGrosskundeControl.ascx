            ...
            <table style="padding: 0px; text-align: left; margin: 0px; border-spacing: 0px;" cellspacing="0" cellpadding="0">
                <tr>
                    <td style="width: 240px; text-align: left;">
                        <telerik:RadTextBox ID="FirstRegistrationDateLabel" runat="server" BorderColor="Transparent" DisabledStyle-BackColor="Transparent" DisabledStyle-ForeColor="Black" Enabled="false" Text="Erstzulassungsdatum: " Visible="True">
                        </telerik:RadTextBox>
                    </td>
