<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="ZulassungLaufkunde.aspx.cs" Inherits="KVSWebApplication.Auftragseingang.ZulassungLaufkunde" %>

<%@ Register TagPrefix="smc" TagName="SmallCustomer" Src="../Auftragseingang/ZulassungLaufkundeControl.ascx" %>
                    ...
                    <div class="exampleWrapper">
                        ...
                        <telerik:RadAjaxPanel runat="server" ID="RadAjaxPanel1" LoadingPanelID="LoadingPanelAuftragseingang" Height="100%" Width="1400px">
                            <div style="float: left;">
                                <smc:SmallCustomer ID="SmallCustomerZulassung" runat="server" />
                            </div>
