<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FehlerhaftZulassung.ascx.cs" Inherits="KVSWebApplication.Auftragsbearbeitung_Neuzulassung.FehlerhaftZulassung" %>
...
<asp:Panel runat = "server" ID = "Panel5">
    ...
    BorderColor="Transparent" DisabledStyle-BackColor = "Transparent" Text = "Sofort- oder Großkunde: " ID = "RadTextBox2" Width = "240px" ></telerik:RadTextBox>
    <telerik:radcombobox id="RadComboBoxCustomer" runat="server" OnSelectedIndexChanged = "SmallLargeCustomerIndex_Changed" 
...
DataTextField = "Name" DataValueField = "Value" ID = "CustomerDropDownList" 
    ...
    <asp:Label ID="FehlerhaftErrorMessage"  ForeColor="Red" runat="server"></asp:Label>
     <telerik:RadGrid AutoGenerateColumns="false" ID="RadGridFehlerhaftZulassung" DataSourceId = "LinqDataSourceFehlerhaft" 
...
<asp:Panel runat = "server" ID = "FahrzeugPanel" >   
    <asp:Label ID="Label1" runat = "server" Text = "Auftragsfehler: "></asp:Label>
