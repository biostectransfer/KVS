            ...
            <tr class="FormContainer">
                <td colspan="2">
                    <asp:CheckBox ID="chbInvoiceSameAsAdress" runat="server" AutoPostBack="true" 
                        ...
                        Text="Rechnungsadresse wie Standard-Adresse" />
                </td>
            </tr>
                    <tr class="FormContainer">
                        <td>
        ...
        <tr class="FormContainer">
          ...
          <table  border="0" cellpadding="5" align="left" >
                ...
                <tbody>
                    <tr class="FormContainer">
                        <td colspan="2">
                            <asp:CheckBox ID="chbSmallCustomerRechnungsaderesse" runat="server" Checked="true" Text="Versandadresse wie Standard-Adresse"  GroupName="CustomerType"
