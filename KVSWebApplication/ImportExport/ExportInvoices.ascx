                ...
                <Columns>
                    <telerik:GridTemplateColumn UniqueName="Exporting" AllowFiltering="false" Display="true">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="InvoiceId" Visible="false" runat="server" Text='<%#  DataBinder.Eval(Container, "DataItem.InvoiceId").ToString() %>'></asp:Label>
                        </ItemTemplate>
                    ...
                    <telerik:GridBoundColumn DataField="InvoiceId" HeaderText="Rechnungsnummer" UniqueName="InvoiceId"
                        AutoPostBackOnFilter="false" Display="false">
                    </telerik:GridBoundColumn>

                    <telerik:GridBoundColumn DataField="InvoiceNumber" HeaderText="Rechnungsnummer" UniqueName="InvoiceNumber"
