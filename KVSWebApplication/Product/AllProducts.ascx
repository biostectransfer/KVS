           ...
           <CommandItemSettings ShowAddNewRecordButton="true"  ShowRefreshButton="true"  />
            <Columns>
                ...
                <telerik:GridCheckBoxColumn DataField="Vat"  ReadOnly="true" HeaderText="MwSt"   UniqueName="Vat"  HeaderButtonType="TextButton"
                    ShowFilterIcon="false" AutoPostBackOnFilter="true" 
                    AllowFiltering="false" ></telerik:GridCheckBoxColumn>
                  ...
                  <table id="tableEditAllProducts" cellspacing="1" cellpadding="1" width="450" Style="height:90% !important;" border="0">
                        ...
                        <tr>
                          ...
                          <tr>
                            ...
                            Text='<%#  DataBinder.Eval(Container, "DataItem.ProductCategorieName").ToString() %>' ></telerik:RadComboBox>  
                            </td>
                        </tr>
                         <tr>
                            <td>
                       ...
                       <tr>
                            ...
                            Enabled='<%#  DataBinder.Eval(Container, "DataItem.EnableDropDown").Equals("true") ? true : false %>' ToolTip ="Gilt nur in Verbindung mit dem Auftragstyp: Zulassung!"
                             ...
                             Text='<%#  DataBinder.Eval(Container, "DataItem.RegistrationOrderTypeName").ToString() %>'></telerik:RadComboBox>
                            </td>
                        </tr>
                         <tr >
                            <td>
                        ...
                        <tr>
                           ...
                           <tr>
                            ...
                            <td>
                             ...
                             runat="server" 
                             Checked='<%#  DataBinder.Eval(Container, "DataItem.Vat").Equals("true") ? true : false %>'  >
                             </asp:CheckBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center" colspan="2">                       
                                <asp:Button ID="btnSave" Text="Ok" runat="server" OnClick="btnSaveProduct_Click" >
                                </asp:Button>&nbsp;
