...
<telerik:RadButton ID="bSchow" runat ="server" Text="Anzeigen" 
        CssClass="CustomerPriceShowButton" onclick="bSchow_Click"></telerik:RadButton>
</td>
</tr>
</table>
</div>
...
<telerik:RadGrid id="getCustomerPrice" runat="server" DataSourceID="GetCustomerProductsDataSource" Culture="de-De"  AllowAutomaticUpdates="false" 
                      ...
                      DataType="System.Decimal" ItemStyle-HorizontalAlign="Center"  ShowFilterIcon="false" AutoPostBackOnFilter="true"/>
                       <telerik:GridTemplateColumn HeaderText="Löschen" HeaderButtonType="TextButton" AllowFiltering="false"
                                         HeaderStyle-HorizontalAlign="Center"  ItemStyle-HorizontalAlign="Center" 
                                          ...
                                          <ItemTemplate>
                                                <asp:Label ID="lblPriceId" Text='<%#  DataBinder.Eval(Container, "DataItem.PriceId").ToString() %>' Visible="false" runat="server"  ></asp:Label>
        ...
        <tr>
            ...
            <asp:TextBox ID="ProductIdCustomer" Visible = "false"  runat="server"  Text='<%#  DataBinder.Eval(Container, "DataItem.Id").ToString() %>'>
                    ...
                    <asp:TextBox ID="LocationIdCustomer" Visible = "false"  runat="server"  Text='<%#  DataBinder.Eval(Container, "DataItem.LocationIdCustomer").ToString() %>'>
                        ...
                        <asp:TextBox ID="txbPriceId" Visible = "false"  runat="server"  Text='<%#  DataBinder.Eval(Container, "DataItem.PriceId").ToString() %>'>
                </asp:TextBox>
        <tr>
            <td>
                Produktname:
                     ...
                     <HeaderTemplate>
                        ...
                        <tr>
                            <td align="center" colspan="2">
                                ...
                                <asp:Button ID="btnSaveCustomerProduct" Text="Ok" runat="server" OnClick="btnSaveProduct_Click" >
                                </asp:Button>&nbsp;
                                <asp:Button ID="btnAbortCustomerProduct" Text="Abbrechen" runat="server" CausesValidation="False" OnClick="btnAbortProduct_Click" >
                                </asp:Button>
                            </td>
                    </tr>
                    </table>
 ...
 OnSelecting="GetCustomerProductsDataSource_Selecting" ></asp:LinqDataSource>
 </div>
