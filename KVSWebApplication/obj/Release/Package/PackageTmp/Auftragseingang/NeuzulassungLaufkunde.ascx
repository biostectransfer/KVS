<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NeuzulassungLaufkunde.ascx.cs" Inherits="KVSWebApplication.Auftragseingang.NeuzulassungLaufkunde" %>
...
<asp:CheckBox Id="invoiceNow" runat="server" Text="Sofortrechnung"  />
 ...
 <div style="float: right; z-index : 100; position : absolute; border : 1px solid;" >
   ...
   BorderColor="Transparent" DisabledStyle-BackColor = "Transparent" Text = "Dienstleistungen: " ID = "RadTextBox4" ></telerik:RadTextBox>
 <br />
